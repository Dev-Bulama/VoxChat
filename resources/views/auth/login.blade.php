...
<div x-data="{ showPassword: false, loading: false }">
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm mt-1">Sign in to continue to VoxChat</p>
    </div>
    ...
    <form method="POST" action="{{ route('login.post') }}" @submit="loading = true" class="space-y-4">
        ...
        <div>
            <div class="flex items-center justify-between mb-1.5">
                ...
                <a href="{{ route('password.request') }}" class="text-xs text-primary-600 hover:text-primary-700 font-medium">Forgot?</a>
            </div>
            <div class="relative">
    ...
    <div class="grid grid-cols-3 gap-3">
        ...
        <a href="{{ route('social.redirect', 'twitter-oauth-2') }}" class="social-btn">
    ...
    <p class="text-center text-sm text-gray-500 mt-5">
        ...
        <a href="{{ route('register') }}" class="text-primary-600 font-semibold hover:text-primary-700">Sign up</a>
    </p>
</div>
@endsection
